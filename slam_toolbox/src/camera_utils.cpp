...
namespace camera_utils
{
  ...
  CameraMetadata::CameraMetadata(karto::LaserRangeFinder *lsr, bool invert)
  {
    laser = lsr;
    inverted = invert;
  };

  bool CameraMetadata::isInverted() const
  {
    return inverted;
  }

  karto::LaserRangeFinder *CameraMetadata::getLaser()
  {
    return laser;
  }

  void CameraMetadata::invertScan(sensor_msgs::LaserScan &scan) const
  {
  ...
  CameraMetadata LaserAssistant::toLaserMetadata(sensor_msgs::LaserScan scan)
  {
    scan_ = scan;
    ...
    CameraMetadata laserMeta(laser, inverted);
    return laserMeta;
  };
  ...
  ScanHolder::ScanHolder(std::map<std::string, laser_utils::CameraMetadata> &lasers)
      : lasers_(lasers)
  {
  ...
  sensor_msgs::LaserScan ScanHolder::getCorrectedScan(const int &id)
  {
    ...
    const laser_utils::CameraMetadata &laser = lasers_[scan.header.frame_id];
    if (laser.isInverted())
    {
